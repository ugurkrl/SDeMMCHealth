...
int mmc_send_csd(struct mmc_card *card, __u32 *csd);
...
int mmc_bus_test(struct mmc_card *card, __u8 bus_width);
int mmc_send_hpi_cmd(struct mmc_card *card, __u32 *status);
